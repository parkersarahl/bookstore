...
Book::Book(string title, string author, double price, int stock, bool countAsNew) {
    this->title = title;
    this->author = author;
    this->price = price;
    this->stock = stock;
    if (countAsNew) bookCount++; // Increment book count when a new book is created
}
Book::Book(const Book& other, bool countAsNew) : Entity(other) {
    // Copy constructor implementation
    this->title = other.title;
    this->author = other.author;
    this->price = other.price;
    this->stock = other.stock;
    if (countAsNew) bookCount++; // Increment book count for the copied book
}
